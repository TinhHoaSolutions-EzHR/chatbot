...
from app.routers.v1 import embedding
from app.routers.v1 import folder
from app.routers.v1 import llm
...
def create_app() -> FastAPI:
    ...
    app.include_router(router=llm.router, prefix=Constants.FASTAPI_PREFIX)
    app.include_router(router=embedding.router, prefix=Constants.FASTAPI_PREFIX)

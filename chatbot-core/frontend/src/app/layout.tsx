...
export async function generateMetadata(): Promise<Metadata> {
  let logoLocation = buildClientUrl("/ezHR.ico");
      ...
      <div className="flex flex-col items-center justify-center min-h-screen">
        ...
        <CardSection className="w-full max-w-md">
          ...
          <p className="text-text-500 mb-4">
            We regret to inform you that your access to EzHR has been
            temporarily suspended due to a lapse in your subscription.
          </p>
          <p className="text-text-500 mb-4">
            To reinstate your access and continue benefiting from EzHR&apos;s

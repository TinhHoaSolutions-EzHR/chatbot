...
* **backend:** add Celery configurations ([2c53163](https://github.com/TinhHoaSolutions-EzHR/chatbot/commit/2c5316352e299906e3a246a85a2ff997b7d326c8))
...
* **backend:** add more celery hooks ([af99fe1](https://github.com/TinhHoaSolutions-EzHR/chatbot/commit/af99fe1545bbde5f6cbadc69b5c0f9b81319982d))
* **backend:** add more helper functions for celery-related logic ([b54af5b](https://github.com/TinhHoaSolutions-EzHR/chatbot/commit/b54af5b9a27d53894d383b499e6eaf8779faeb22))
...
* **backend:** add one worker in docker compose ([9dd15fd](https://github.com/TinhHoaSolutions-EzHR/chatbot/commit/9dd15fd6602f9bc87924b4539ca4cb8fb1c8233c))
...
* **backend:** add seeding implementation ([422c603](https://github.com/TinhHoaSolutions-EzHR/chatbot/commit/422c603a5de0dfb634e3c3d18b4d15bd687b389d))
* **backend:** add threading-safe to database's base class ([b3f2d5e](https://github.com/TinhHoaSolutions-EzHR/chatbot/commit/b3f2d5eff6ac1ee23b5792f660eb50680e8daa05))
...
* **backend:** add unit test for storage ([e9de657](https://github.com/TinhHoaSolutions-EzHR/chatbot/commit/e9de65749d5e20014aa60b4a3065e570b22fe357))
...
* **backend:** endpoint for document upload and indexing pipeline ([e0f2072](https://github.com/TinhHoaSolutions-EzHR/chatbot/commit/e0f2072a49c6b201a1bdc345a3da326b76f2964d))
...
* **backend:** initialize celery basic code ([295e1ed](https://github.com/TinhHoaSolutions-EzHR/chatbot/commit/295e1ed43b711bc2216f0c9d1be1994909a60d94))
...
* **backend:** migrate to mssql ([2cfe9be](https://github.com/TinhHoaSolutions-EzHR/chatbot/commit/2cfe9beb7aa42cca4c9aed9690897682a4881c24))
* **backend:** modify & add object storage Dockerfile ([c546a01](https://github.com/TinhHoaSolutions-EzHR/chatbot/commit/c546a01e1e70865d3989a2fdc7332ec496e9c75d))
* **backend:** modify & add resource intialization in fast api ([429ac01](https://github.com/TinhHoaSolutions-EzHR/chatbot/commit/429ac0171c9bb48551d470d29215d4e27db2e4c5))
...
* **backend:** update POC notebook ([23e29d1](https://github.com/TinhHoaSolutions-EzHR/chatbot/commit/23e29d1479b439b06e4d95739e20d8586c40bb38))
...
* **docker:** setup development infrastructure under docker compose ([#49](https://github.com/TinhHoaSolutions-EzHR/chatbot/issues/49)) ([4c40a5d](https://github.com/TinhHoaSolutions-EzHR/chatbot/commit/4c40a5d24f6db8383c5b78970e561ed2f608873c)), closes [#35](https://github.com/TinhHoaSolutions-EzHR/chatbot/issues/35)
...
* **docs:** add API documentation and Swagger viewer component ([f5c2a8f](https://github.com/TinhHoaSolutions-EzHR/chatbot/commit/f5c2a8fa5f86db20fe678a61d47db7f839ed4a6d))
* **docs:** add api-build script and remove deprecated API documentation files ([f673c81](https://github.com/TinhHoaSolutions-EzHR/chatbot/commit/f673c814a53dadbc33f0d9c757aaf6ca4b26d12c))
* **docs:** add new dependencies for Swagger UI and improve component imports ([81569e6](https://github.com/TinhHoaSolutions-EzHR/chatbot/commit/81569e6f63438884d4dac711873a240629bcf5e6))
* **docs:** add ver two donut ([a5dfb83](https://github.com/TinhHoaSolutions-EzHR/chatbot/commit/a5dfb837bb1eb2f64a9a37ae432ee5a368fd6b9a))
* **docs:** deploy docs on github pages ([#75](https://github.com/TinhHoaSolutions-EzHR/chatbot/issues/75)) ([15486a4](https://github.com/TinhHoaSolutions-EzHR/chatbot/commit/15486a4b2e39e647abe68fe864b5c0bc8d589a5f))
* **docs:** deploy docs on github pages ([#76](https://github.com/TinhHoaSolutions-EzHR/chatbot/issues/76)) ([db7c52d](https://github.com/TinhHoaSolutions-EzHR/chatbot/commit/db7c52db56d2935d81e29d88db14bca5c0206d10))
* **docs:** have a donut ([8fb7a93](https://github.com/TinhHoaSolutions-EzHR/chatbot/commit/8fb7a93777381436c7feb11a5bb6bd6120ce8d95))
* **docs:** initialize documentation structure with new sidebar, local development guide, and configuration files ([4fe60c8](https://github.com/TinhHoaSolutions-EzHR/chatbot/commit/4fe60c892ffaa115ad5d2ea1f972c4297ead5aea))
* **docs:** initialize Docusaurus site structure and add essential configuration files ([154a2d8](https://github.com/TinhHoaSolutions-EzHR/chatbot/commit/154a2d8d91c768e2325a74ae659280c641757b3d))
* **docs:** restructure documentation by adding new author and guide sections, removing deprecated files, and updating configuration ([283f5ca](https://github.com/TinhHoaSolutions-EzHR/chatbot/commit/283f5ca369ce647c6fb88606121b46f936793924))
...
* **docs:** update component props with default values and improve imports ([ab163fa](https://github.com/TinhHoaSolutions-EzHR/chatbot/commit/ab163fadbf49fbb8f01ce88bc1a2cbc567770a55))
...
* **frontend:** implement drag-and-drop functionality for chat sessions in sidebar ([48efc73](https://github.com/TinhHoaSolutions-EzHR/chatbot/commit/48efc73797a0a0ea7cb09594b252719d2a875b16))
...
* **frontend:** Reinit frontend code ([8ed61fc](https://github.com/TinhHoaSolutions-EzHR/chatbot/commit/8ed61fc51b460e4c77105951150aca6740bedb2f))
...
* **lmao:** add lmao lmao ([f388b08](https://github.com/TinhHoaSolutions-EzHR/chatbot/commit/f388b08d76ff2a7c4e7c0101479d11f16b67e8f9))
* **notebook:** add jupyter notebook for POC 1 ([382edfb](https://github.com/TinhHoaSolutions-EzHR/chatbot/commit/382edfb78329539b63dc3e8a2cca001b165645cd))
* **notebook:** add notebook for POC 1 ([7a10334](https://github.com/TinhHoaSolutions-EzHR/chatbot/commit/7a10334e6f12158daf305e8367c304e58ece5926))
...
* **notebook:** init notebook POC1 ([b735061](https://github.com/TinhHoaSolutions-EzHR/chatbot/commit/b73506155c8dbd7c09fbaceb87bd3bf83f13e979))
...
* **notebook:** update BM25 & complete POC 1 flow ([f5d1c2d](https://github.com/TinhHoaSolutions-EzHR/chatbot/commit/f5d1c2d5b8f8df7d6291b38c470fb4df55e5780e))
...
* **README:** update readme ([a19b124](https://github.com/TinhHoaSolutions-EzHR/chatbot/commit/a19b124fd22837ae09dcdfe8fcdbe2e23f7fe591))
* **README:** update readme ([#5](https://github.com/TinhHoaSolutions-EzHR/chatbot/issues/5)) ([7c026c2](https://github.com/TinhHoaSolutions-EzHR/chatbot/commit/7c026c2e8c4f5bb7fb2699db7cfeab3fa9e64975)), closes [#4](https://github.com/TinhHoaSolutions-EzHR/chatbot/issues/4)
* update internal URL and add web server configuration to Docker Compose ([0e90558](https://github.com/TinhHoaSolutions-EzHR/chatbot/commit/0e90558886e02d8662a5abc1ba5a79c04cd5cb60))
...
* **backend:** add virtual env creation when building image ([11563d7](https://github.com/TinhHoaSolutions-EzHR/chatbot/commit/11563d734cfed48c7248331183d07104b37c7406))
...
* **backend:** api's connection to mssql ([7b03e82](https://github.com/TinhHoaSolutions-EzHR/chatbot/commit/7b03e82e5b30fc8505e2899a229e9c4dcaae007b))
...
* **docs:** remove unused rehype and remark plugins from configuration ([575973a](https://github.com/TinhHoaSolutions-EzHR/chatbot/commit/575973a05b74c1292675fa88f1be4c31cfcb6456))
* **docs:** update base URL in docusaurus configuration for local development ([7cf8471](https://github.com/TinhHoaSolutions-EzHR/chatbot/commit/7cf8471646fda98d84c1f9dbbc56c3536fc8f6a4))
...
* **frontend:** correct query parameter separator in PersonaTable navigation ([8c243da](https://github.com/TinhHoaSolutions-EzHR/chatbot/commit/8c243dae0ed3c20751c7f6051a4cd6336921d125))
...
* **frontend:** fix logout standard ([411bcb1](https://github.com/TinhHoaSolutions-EzHR/chatbot/commit/411bcb16804d52dd81cf7e37b550c5d9e6fc403b))
...
* **docker:** optimize backend docker image ([a864000](https://github.com/TinhHoaSolutions-EzHR/chatbot/commit/a8640000fe94d78b2b06f2338e18fb42a165612d))
* **docker:** update cache for backend Dockerfile ([8429ad4](https://github.com/TinhHoaSolutions-EzHR/chatbot/commit/8429ad4be48f787228a7a60216d28f59353a4f3c))

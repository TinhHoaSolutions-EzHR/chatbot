...
export default [
  {
    path: '/blog',
    component: ComponentCreator('/blog', 'ade'),
    exact: true
  },
  {
    path: '/blog/archive',
  ...
  {
    path: '/blog/authors/a-1-k-0-n',
    component: ComponentCreator('/blog/authors/a-1-k-0-n', '42b'),
    exact: true
  },
  {
    path: '/blog/authors/lekiet',
    component: ComponentCreator('/blog/authors/lekiet', 'a60'),
    exact: true
  },
  {
    path: '/blog/donut',
    component: ComponentCreator('/blog/donut', 'f31'),
    exact: true
  },
  {
    path: '/blog/tags',
  ...
  {
    path: '/blog/tags/blog/donut/',
    component: ComponentCreator('/blog/tags/blog/donut/', 'cdc'),
    exact: true
  },
  {
    path: '/docs',
        ...
        routes: [
          {
            ...
            routes: [
              ...
              {
                path: '/docs/intro',
                component: ComponentCreator('/docs/intro', '073'),
                exact: true,
                sidebar: "localDevelopmentGuideSidebar"
              },
              {

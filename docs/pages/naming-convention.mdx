...
import imgSemanticRelease from "../public/assets/naming-conventions/semantic-release.jpg";

<Screenshot src={imgSemanticRelease} alt="Commit Conventions" />
...
import imgCommitConvention from "../public/assets/naming-conventions/git-naming-convention.png";

<Screenshot src={imgCommitConvention} alt="Commit Conventions" />

...
import imgSemanticRelease from "../../static/img/namingConventions/semantic-release.jpg";

<img src={imgSemanticRelease} alt="Commit Conventions" />
...
import imgCommitConvention from "../../static/img/namingConventions/git-naming-convention.png";

<img src={imgCommitConvention} alt="Commit Conventions" />
